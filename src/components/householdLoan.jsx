        ...
        <div className="p-4 md:w-1/3 card">
            <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                <img
                    ...
                    src={'https://asaanghar.com/wp-content/uploads/2024/07/House-Loans-in-Pakistan-769x460_c.jpg'}
                    alt="blog"
                />
                <div className="p-6">
                    ...
                    <p className="leading-relaxed mb-3">
                        <ul className='text-[14px]'>
                            <li> Subcategories: Home Appliances (Fridge, TV, Washing Machine, etc.)</li>
                            <li>Maximum loan: PKR 10 Lakh and based on requirement</li>
